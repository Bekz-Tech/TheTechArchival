...
const StudentManagement = () => {
  ...
  return (
    <Grid container spacing={3}>
      ...
      <Grid item xs={12} >
        <Paper elevation={3} style={{ padding: '20px', display: "grid", gap: "10px"}}>
          <Typography variant="h6" gutterBottom>
            Add New Student
          </Typography>
          <TextField
            ...
            fullWidth
            margin="normal"
            // Implement onChange and value handlers for student details
          />
          <TextField
            label="Email Address"
            variant="outlined"
            fullWidth
            margin="normal"
            // Implement onChange and value handlers for email
          />
          <Button sx={{width:"20%"}} variant="contained" color="primary" onClick={handleAddStudent}>
            Add Student
          </Button>
        </Paper>
      </Grid>
