...
const useSignUp = ({ offline, role }) => {
    ...
    const { data, loading, error: submitError, callApi } = useApi(endpoints.USER);
    ...
    const fetchCohorts = async (courseId) => {
        try {
            ...
            const response = await fetch(`http://localhost:5000/api/v1/${courseId}/cohorts`);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            await callApi('POST', formDataToSubmit, '', {
